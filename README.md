...
This is a simple yet quite nice and cozy "ToDo" app, that enables a user to "add" new tasks and reorder them in an appropriate columns, such as "ToDo" / "In Progress" / "Done" . It has "Drag&Drop" functionality that enable user to drag and drop tasks as from one column to another and alsoreorder them inside each column.
It also shows and realtime calculates numbers of completed and alltasks.
